...
void overlayESP::initWindow(int nShowCmd) {
	...
	imGuiMenu::normalText= io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\msyh.ttc", 15.f,nullptr,io.Fonts->GetGlyphRangesChineseFull());
	imGuiMenu::titleText = io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\msyh.ttc", 16.f, nullptr, io.Fonts->GetGlyphRangesChineseFull());
	imGuiMenu::subTitleText = io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\msyh.ttc", 15.f, nullptr, io.Fonts->GetGlyphRangesChineseFull());
	imGuiMenu::highlightText = io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\msyh.ttc", 13.f, nullptr, io.Fonts->GetGlyphRangesChineseFull());
	imGuiMenu::espNameText = io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\msyh.ttc", 15.f, nullptr, io.Fonts->GetGlyphRangesChineseFull());
	imGuiMenu::weaponIcons = io.Fonts->AddFontFromFileTTF(timAppleSystem::weaponIconsTTF.c_str(), 20.f, nullptr, io.Fonts->GetGlyphRangesChineseFull());
